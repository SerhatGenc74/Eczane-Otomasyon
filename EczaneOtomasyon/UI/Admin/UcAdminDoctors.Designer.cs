...
namespace EczaneOtomasyon.UI.Admin
{
    partial class UcAdminDoctors
    {
        ...
        private TextBox _txtBrans;
        private TextBox _txtKurum;
        ...
        private Control BuildForm()
        {
            ...
            _txtBrans = AdminUi.CreateTextBox();
            _txtKurum = AdminUi.CreateTextBox();

            form.Controls.Add(AdminUi.CreateSectionTitle("Doktor Bilgisi"), 0, 0);
            form.Controls.Add(BuildFieldRow("Ad Soyad", _txtAdSoyad), 0, 1);
            form.Controls.Add(BuildFieldRow("Branş", _txtBrans), 0, 2);
            form.Controls.Add(BuildFieldRow("Kurum", _txtKurum), 0, 3);
            form.Controls.Add(BuildButtons(), 0, 4);
